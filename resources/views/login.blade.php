    ...
    <div class="row innerPage justify-content-center align-items-center h-100 w-100">
        <div class="col-xl-5 col-lg-6 col-md-7 col-sm-8 col-12 Sign_Up position-relative">
            <div class="card border-0 bg-white py-4 px-md-5 px-3">
                ...
                <form method="POST" action="{{ route('login') }}" class="needs-validation pt-sm-5 pt-3 pb-3" id="form2" novalidate>
                    @csrf
                    <div class="row">

                        <div class="col-12 mb-3">
                            <input type="email" placeholder="Email Address" class="form-control shadow-none rouded-0 Inpt w-100 border-0 p-2 fs-16 fw-normal @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required  >
                        </div>

                        <div class="col-12 mb-3 password-field position-relative">
                            <input type="password" placeholder="Password" class="form-control shadow-none rouded-0 Inpt w-100 border-0 p-2 fs-16 fw-normal @error('password') is-invalid @enderror" name="password" required >

    ...
    <div class="container-fluid">
        <div class="topBar py-4">
            <div class="row justify-content-between mx-0">
                <div class="col-auto">
                    <div class="title text-theme1 fs-24 fw-bold ">My Event</div>
                </div>
                <div class="col-auto">
                    <a class="btn createEventBtn btn-theme1 text-white fs-14 py-1 px-3 text-uppercase fw-500" href=""> Create Event </a>
                </div>
            </div>
        </div>
        <div class="totalEvents py-4">
            <div class="row mx-0">
                <div class="col-auto">
                    <button type="button" class="btn btn-dark fw-500">
                        Upcoming <span class="badge text-bg-light ms-2">3</span>
                    </button>
                </div>
                <div class="col-auto">
                    <button type="button" class="btn btn-outline-dark fw-500">
        ...
        <div class="upcomingEvents py-4">
            <div class="row mx-0">
                <div class="col-12">
                    <div class="title text-dark fs-22 fw-bold ">Upcoming Events</div>
                </div>

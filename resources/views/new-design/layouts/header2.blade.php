<nav class="navbar navbar-expand-lg bg-theme2 fixedHeader">
  <div class="container-fluid">
    ...
    <div class="nav-body d-flex align-items-center" id="navbarSupportedContent">
        <!-- SideClick Button -->
        <div class="me-3">
        <button id="SideClick" class="show_sidebar_btn shadow-none border-0 rounded bg-transparent d-flex justify-content-center align-items-center" ><i class="imgs img-bars fs-sm-25 fs-20 text-white"></i></button>
        </div>

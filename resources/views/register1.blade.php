                ...
                <div class="col-md-6 pos-rel">
                    <div class="card border-0 ">
                        <div class="text-center p-4"><img src="https://i.ibb.co/wh09ybR/logo.png" alt="Logo"
                                width="95"></div>
                        <div class="text-center f-18">Have an account? <a href="/guest/login" target=""
                                style="text-decoration: none;"><span style="color: #ff4e00;">Sign In!</span></a></div>
                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-md-8 d-flex">
                                        ...
                                        <input id="name" type="text"
                                            class="form-control CustomInput shadow-none @error('name') is-invalid @enderror"
                                ...
                                <div class="row justify-content-center" style="margin-top:15px">
                                    <div class="col-md-8">
                                        ...
                                        <input id="email" type="email"
                                            ...
                                            name="email" placeholder="Enter Your E-mail" value="{{ old('email') }}"
                                ...
                                <div class="row justify-content-center" style="margin-top:15px">
                                    <div class="col-md-8">
                                        <label for="password" class="col-form-label fs-16 p-0"></label>
                                        <input id="password" type="password"
                                            class="form-control CustomInput shadow-none" name="password_confirmation"
                                ...
                                <div class="d-flex justcon-spaaro" style="margin-top:15px">
                                    ...
                                    <div class="view-swtich-wrapper">
                                        ...
                                        <label class="switch-label" for="ccx-comments-switch-view"> I agree to Vue's Term
                    ...
                    <div><img src="https://i.ibb.co/PF6cVcb/black-tri-removebg-preview.png"
                            alt="black-tri-removebg-preview" class="black-tri" width="75"></div>
                    <div><img src="https://i.ibb.co/d2gBwXH/orange-tri-removebg-preview.png"
                            alt="orange-tri-removebg-preview" class="orange-tri" width="63"></div>

      ...
      <ul class="navbar-nav me-auto mb-0">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu rounded-0 p-0 bg-theme2 top-lg-45px top-41px">
            <li><a class="dropdown-item text-white d-flex justify-content-start align-items-center gap-2" href="{{route('useraccount')}}"><i class="imgs img-user text-white fs-18"></i> <span class="fs-16">My Account</span> </a></li>

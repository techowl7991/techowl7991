                            ...
                            <ul class="list-unstyled p-0 m-0">
                                ...
                                <li class="pt-2 pb-1 px-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label justify-content-between d-flex fs-12 fs-sm-14"
                                            for="customcheckbox23"><span>Checked In</span><span
                                                class="value">{{ count($sidedata['checkedin']) }}</span></label>
                                    </div>
                                </li>
                                <li class="py-1 px-3">
                                    <div class="form-check">

                                        <input type="radio" id="customcheckbox22" name="visit" value="checkout"
                                            class="form-check-input visit border border-2 border-theme2 w-18px h-18px shadow-none rounded-4 mt-0"
                                            <?php if ($visit == 'No') {
                                                echo 'checked';
                                            } ?>>
    ...
    <div class="container-fluid">
        <div class="row" style="height:100%">
            ...
            <div class="col-11">
                ...
                <!-- add guest start-->
                <div class="modal fade Create-Guest-modal" id="exampleModal" data-bs-backdrop="static" tabindex="-1"
                ...
                <div class="modal fade Create-Guest-modal" id="exampleModal1" data-bs-backdrop="static" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content">
                            <div class="modal-header py-3 border-0">
        ...
        function openmodal(id, mid) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $(`#tags1 option[value="${response.data.tags}"]`).attr("selected", "selected");

                            ...
                            <ul class="list-unstyled p-0 m-0">
                                <li class="py-2 px-3">
                                    <div class="form-check">
                                        ...
                                        <input type="checkbox" id="customcheckbox1" name="allval" class="custom-control-input allval form-check-input visit border border-2 border-theme2 w-18px h-18px shadow-none rounded-4 mt-0" value="Yes" <?php if ($allval == 'Yes' or $allval == '') {
                                                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                                                } ?>>
                                        <label class="form-check-label justify-content-between d-flex fs-12 fs-sm-14" for="customcheckbox1"><span>All Guests</span><span class="value">{{ $sidedata['total'] }}</span></label>
                                    </div>
                                </li>
                                <li class="py-1 py-sm-2 px-2 px-sm-3 bg-theme2 text-white fs-13 fs-sm-14">Status</li>
                                <li class="pt-2 pb-1 px-3">
                                    <div class="form-check">
                                        <input class="form-check-input visit border border-2 border-theme2 w-18px h-18px shadow-none rounded-4 mt-0" type="radio" name="visit" value="checkin" id="customcheckbox23" <?php if ($visit == 'Yes') {
                                                                                                                                                                                                                            echo 'checked';
                                                                                                                                                                                                                        } ?>>
                            ...
                            <div class="form-check">
                                ...
                                <li class="pt-2 pb-1 px-3">
                                    <div class="form-check">
                                        ...
                                        <label class="form-check-label justify-content-between d-flex fs-12 fs-sm-14" for="customcheckbox73"><span>VIP</span><span class="value">{{ count($sidedata['vip']) }}</span></label>
                                    </div>
                                </li>
                                <li class="py-1 px-3">
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input type border border-2 border-theme2 w-18px h-18px shadow-none rounded-4 mt-0" type="radio" name="type" value="Reg" id="customcheckbox72" <?php if ($type == 'Reg') {
                                                                                                                                                                                                                    echo 'checked';
                                                                                                                                                                                                                } ?>>
                                        <label class="form-check-label justify-content-between d-flex fs-12 fs-sm-14" for="customcheckbox72"><span>Regular</span><span class="value">{{ count($sidedata['reg']) }}</span></label>
                                    </div>
                                </li>
                                {{--
                        <li class="py-1 px-3">
            ...
            <div class="col-lg-9">
                <div class="row">
                            ...
                            <div class="row justify-content-between align-items-center">
                                <div class="col-12 col-sm-auto col-xl-3">
                                    <div class="geustValue">
                                        ...
                                        <div class="countValue text-theme2 fs-14 fs-md-16 fs-xl-20 fw-bold mt-n2 mt-xl-n2"><span class="text-theme1 fs-16 fs-md-20 fs-xl-28">{{$sidedata['total']}}</span> All Guests</div>
                                    </div>
                                </div>
                                <div class="col-12 col-sm-auto mt-3 mt-sm-0">
                                    <div class="buttonsGroup d-sm-flex gap-2 d-inline-block">
                                        ...
                                        <a href="{{ url('/exportdata/' . $id) }}" type="btn" class="btn btn-theme2 fs-10 fs-lg-11 fs-xl-14  fw-600 text-uppercase my-1 my-sm-0" disabled>Export</a>
                                        <button type="btn" class="btn btn-theme2 delbtn fs-10 fs-lg-11 fs-xl-14  fw-600 text-uppercase my-1 my-sm-0">Delete</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <table class="table table-bordered mt-0 table-striped table-hover text-nowrap  dt-responsive nowrap" id="allmatches_datatable" width="100%" cellspacing="0">
            ...
            <div class="row" style="height:100%">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body p-0">
                                    <div class="row px-0 mx-0">
                                        ...
                                        <form action="{{ route('addguest') }}" method="post" class="modal-form col-12 mt-3" enctype="multipart/form-data">
                                            @csrf
                                            <input type="hidden" name="mid" value="{{ $id }}">
                                            <div class="row">
                                                <div class="col-3 d-flex justify-content-center">
                                            ...
                                            <div class="col-12 px-0 py-3 d-flex justify-content-center gap-2 fotter_button">
                                                <button type="button" class=" shadow-none rounded cancle_btn fs-14 fw-bold px-4 py-2" data-bs-dismiss="modal">CANCEL</button>
                                                <button type="submit" class=" shadow-none border-0 text-white bg-theme1 rounded fs-14 fw-bold px-4 py-2">SAVE
                                                    CHANGES</button>
                                            </div>
                ...
                <div class="modal fade Create-Guest-modal" id="exampleModal1" data-bs-backdrop="static" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-lg">
                        <div class="modal-content">
                            <div class="modal-header py-3 border-0">
                                <h5 class="modal-title fs-20 text-theme2 fw-bold" id="editguest">Edit Guest Information
                                </h5>
                                <h5 class="modal-title fs-20 text-theme2 fw-bold" id="viewguest">View Guest Information
                                </h5>
                                <!-- <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button> -->
                                <i class="imgr img-times fs-20" data-bs-dismiss="modal" aria-label="Close"></i>
                            </div>

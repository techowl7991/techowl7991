                        ...
                        <form id="subform" action="{{ asset('/addEvent') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row g-3 needs-validation">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="eventname" required style="border:none;border-bottom:2px solid grey;border-radius:0px;box-shadow:none">
                                 ...
                                 <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="eventpassword" required style="border:none;border-bottom:2px solid grey;border-radius:0px;box-shadow:none">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="datetime-local" class="form-control" name="eventstartdate" required style="border:none;border-bottom:2px solid grey;border-radius:0px;box-shadow:none">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="datetime-local" class="form-control" name="eventenddate" required style="border:none;border-bottom:2px solid grey;border-radius:0px;box-shadow:none">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="address" required style="border:none;border-bottom:2px solid grey;border-radius:0px;box-shadow:none">
                                    <div class="valid-feedback">
                                        Looks good!
                                    </div>
                                </div>

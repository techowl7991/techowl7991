...
class AboutController extends Controller
{
    ...
    public function exportdata(Request $request)
    {
        ...
        foreach ($data as $value) {
            // dd($value);
            $alldata['title'] = $value['nmtitle'];
            $alldata['firstname'] = $value['evefirstname'];
            $alldata['lastname'] = $value['evelastname'];
            $alldata['email'] = $value['eveemail'];
            $alldata['jobtitle'] = $value['jobtitle'];
    ...
    public function view_eventdetail_dt(Request $request)
    {
        ...
        if ($totalTitles != 0) {
            ...
            foreach ($titles as $title) {
                ...
                $nestedData['name'] = $title['evefirstname'] . ' ' . $title['evelastname'];
                ...
                foreach ($read as $value) {
                    if ($index == 0) {
                        ...
                        $eventData = [
                            ...
                            'evelastname' =>  $value[2] ? $value[2] : '',
                            'eveemail' => $value[3] ? $value[3] : '',
                            'jobtitle' =>  $value[4] ? $value[4] : '',
                            'orgenization' => $value[5] ? $value[5] : '',
                            'type' => $value[6] ? $value[6] : '',
                            'tags' => $value[7] ? $value[7] : '',
                            'linkedin' => $value[8] ? $value[8] : '',
                            'twitter' => $value[9] ? $value[9] : '',

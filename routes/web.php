...
Route::any('ticketprintdata', [AboutController::class, 'ticketprintdata'])->name('ticketprintdata');
...
Route::get('analytics_booth_name/{id}', [AboutController::class, 'analytics_booth_name'])->name('analytics_booth_name');
...
Route::any('/sign-up', function () {
    return view('new-design/auth/sign_up');
});
Route::any('/sign-in', function () {
    return view('new-design/auth/sign_in');
});
Route::any('/add-event', function () {
    return view('new-design/add-event');
});
Route::any('/create-event', function () {
    return view('new-design/create-event');
});
Route::any('/dashboard', function () {
    return view('new-design/dashboard');
});
Route::any('/analytics', function () {
    return view('new-design/analytics');
});
Route::any('/analytics-booth-name', function () {
    return view('new-design/analytics-booth-name');
});
Route::any('/setting', function () {
    return view('new-design/setting');
})->name('setting');
Route::any('/email11', function () {
    return view('new-design/email');
});
Route::any('/campaign-nformation', function () {
    return view('new-design/campaign-nformation');
});

Route::any('/my-event', function () {
    return view('new-design/my-event');
});
Route::any('/my-account', function () {
    return view('new-design/my-account');
});
Route::any('/guests', function () {
    return view('new-design/guests');
});
Route::any('/email2', function () {
    return view('new-design/email2');
});
Route::any('/new-page', function () {
    return view('new-design/new-page');
});
